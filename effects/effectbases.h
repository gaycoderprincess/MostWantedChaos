...
class EffectBase_NotInRaceConditional : public ChaosEffect {
public:
	EffectBase_NotInRaceConditional(const char* category) : ChaosEffect(category) {
		sName = "(EFFECT BASE) Not In Race Conditional";
	}
